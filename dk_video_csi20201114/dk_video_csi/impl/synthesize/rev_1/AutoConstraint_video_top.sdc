...
define_clock -name {video_top|pix_clk} {n:video_top|pix_clk} -period 5.270 -clockgroup Autoconstr_clkgroup_0 -rise 0.000 -fall 2.635 -route 0.000 
...
#Begin clock constraint
define_clock -name {video_top|eth_rxc} {p:video_top|eth_rxc} -period 66667.000 -clockgroup Autoconstr_clkgroup_11 -rise 0.000 -fall 33333.500 -route 0.000 
#End clock constraint

#Begin clock constraint
define_clock -name {pll_8bit_2lane|clkout_inferred_clock} {n:pll_8bit_2lane|clkout_inferred_clock} -period 8500.713 -clockgroup Autoconstr_clkgroup_12 -rise 0.000 -fall 4250.357 -route 0.000 
#End clock constraint

#Begin clock constraint
define_clock -name {_~idesx4_DPHY_RX_TOP__|clk_byte_out_inferred_clock} {n:_~idesx4_DPHY_RX_TOP__|clk_byte_out_inferred_clock} -period 6.494 -clockgroup Autoconstr_clkgroup_13 -rise 0.000 -fall 3.247 -route 0.000 
#End clock constraint

#Begin clock constraint
define_clock -name {_~idesx4_DPHY_RX_TOP__|eclko_inferred_clock} {n:_~idesx4_DPHY_RX_TOP__|eclko_inferred_clock} -period 66667.000 -clockgroup Autoconstr_clkgroup_14 -rise 0.000 -fall 33333.500 -route 0.000 
#End clock constraint

#Begin clock constraint
define_clock -name {video_top|I_clk_27m} {p:video_top|I_clk_27m} -period 4.277 -clockgroup Autoconstr_clkgroup_15 -rise 0.000 -fall 2.139 -route 0.000 
#End clock constraint

#Begin clock constraint
define_clock -name {video_top|aud_bclk} {p:video_top|aud_bclk} -period 8502.405 -clockgroup Autoconstr_clkgroup_16 -rise 0.000 -fall 4251.202 -route 0.000 
#End clock constraint

#Begin clock constraint
define_clock -name {i2c_dri_Z8|dri_clk_derived_clock} {n:i2c_dri_Z8|dri_clk_derived_clock} -period 4240.010 -clockgroup Autoconstr_clkgroup_1 -rise 0.000 -fall 2120.005 -route 0.000 
#End clock constraint

#Begin clock constraint
define_clock -name {_~DPHY_RX_DPHY_RX_TOP__|HS_CLK_inferred_clock} {n:_~DPHY_RX_DPHY_RX_TOP__|HS_CLK_inferred_clock} -period 1.635 -clockgroup Autoconstr_clkgroup_17 -rise 0.000 -fall 0.817 -route 0.000 
#End clock constraint
